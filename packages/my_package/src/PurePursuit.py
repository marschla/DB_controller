...
class ControllerNode(DTROS):
    ...
    def process_segments(self, input_segment_list):
        ...
        for segment in all_segments:
            ...
            if segment.color == 0 and ave_point_y > -0.05: #and ave_point_y > -0.25:    
        ...
        if flag == True:
            ...
            self.omega = 4.8*self.v* np.sin(alpha)/self.lookahead #4.8*self.vref* np.sin(alpha)/self.lookahead
