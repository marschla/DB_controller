...
class ControllerNode(DTROS):
    ...
    def process_segments(self, input_segment_list):
        ...
        for segment in all_segments:
            ...
            if segment.color == 0: #and ave_point_y < 0.1 and ave_point_y > -0.15: # and ave_point_y > -0.05: #and ave_point_y > -0.25:    
        ...
        if num_white == 0 and num_yellow == 0:
            ...
            #rospy.logwarn("No segments in range")
        ...
        if flag == True:
            ...
            self.omega = 3.*self.v* np.sin(alpha)/self.lookahead 
